...
import // isValidCardType
// removeAllNonDigitValues
"../../components/Forms/PaymentForm/utils";
...
const paymentMachineOptions = () => ({
  guards: {
    isBadCard: context => {
      ...
      // const isValid = isValidCardType(cleanStr);
      // console.log(isValid);
      // return context.length >= 15;

      // return !isValidCardType(context.creditCard);
      console.log(cleanStr);
      console.log(!CREDIT_CARD_REGEX.test(cleanStr));
